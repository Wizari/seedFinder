...
import com.gmail.wizaripost.seedFinder.service.actions.RegisterService
import com.gmail.wizaripost.seedFinder.service.actions.SpinService
import org.springframework.stereotype.Service

@Service
class RegisterRoundStage(
    private val spinService: RegisterService,
    ...
    override fun valid(action: String): Boolean {
        return action.uppercase() == "REGISTER"
    }
    ...
    override fun  execute(params: Map<String, Any>?): RoundStageResponse {
        ...
        resultPostProcessor.process("Register", responseString)
